...
import { getProvidersInfo, search, isProviderSupported, providers } from '../services/torrent-search'
...
export function getBrowseRouter(_config: Config, _logger: Logger): Router {
    return Router()
        ...
        .get<Record<'provider' | 'torrentId', string>, MagnetModel, {}, {}>('/browse/providers/:provider/magnet/:torrentId', async (req, res) => {
