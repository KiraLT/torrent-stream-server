...
export function ProviderCategoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProviderCategory {
    ...
    return {
        ...
        'name': json['name'],
        'id': json['id'],
        'subcategories': ((json['subcategories'] as Array<any>).map(ProviderCategorySubcategoriesFromJSON)),
    };
}
