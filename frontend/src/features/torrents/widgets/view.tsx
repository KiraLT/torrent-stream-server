...
export function TorrentViewWidget({
    ...
    return (
        <>            
            <GoogleDrivePopupWidget url={file.stream} name={file.name} open={gdriveOpen} onClose={() => setGdriveOpen(false)}/>
            <FilePlayerWidget url={file.stream} name={file.name} type={file.type} />
            <Card className="mt-3">
                <Card.Header>
                    <Row className="">
                        ...
                        <Col sm="auto" className="d-flex mb-3">
                            <DropdownButton title="Download" variant="success" className="w-100 justify-content-center align-self-center">
                                ...
                                >
                                    <i className="ti-google"></i> Save to google drive
                                </Dropdown.Item>
                            </DropdownButton>
                        </Col>
                    </Row>
