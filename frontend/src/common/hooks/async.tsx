...
import { useAsync as _useAsync, UseAsyncReturn, UseAsyncOptions } from 'react-async-hook'

export function useAsync<R = unknown, Args extends any[] = any[]>(
    asyncFunction: () => Promise<R>, params: Args, options?: UseAsyncOptions<R> & { refreshInterval?: number }
