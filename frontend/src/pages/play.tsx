...
import { TorrentsApi, TorrentModel, TorrentFileModel } from 'common/api'
import { getApiConfig } from 'config'
import { addHistoryItem } from 'features/history'
import { TorrentFileViewer } from 'features/player'
...
export default withBearer(({ bearer }) => {
    ...
    return (
        <Container className="mt-3">
            {torrent.error && <ErrorMessage error={torrent.error} retry={torrent.execute} />}
            {torrent.loading && <Loader />}
