...
export class BrowseApi extends runtime.BaseAPI {
    ...
    /**
     */
    async searchTorrentsRaw(requestParameters: SearchTorrentsRequest): Promise<runtime.ApiResponse<Array<ProviderTorrent>>> {
        if (requestParameters.query === null || requestParameters.query === undefined) {
            throw new runtime.RequiredError('query','Required parameter requestParameters.query was null or undefined when calling searchTorrents.');
        }

        if (requestParameters.provider === null || requestParameters.provider === undefined) {
            throw new runtime.RequiredError('provider','Required parameter requestParameters.provider was null or undefined when calling searchTorrents.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(ProviderTorrentFromJSON));
    }

    /**
     */
    async searchTorrents(requestParameters: SearchTorrentsRequest): Promise<Array<ProviderTorrent>> {
