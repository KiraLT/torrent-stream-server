...
export class TorrentsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async createTorrentRaw(requestParameters: CreateTorrentRequest): Promise<runtime.ApiResponse<Torrent>> {
        if (requestParameters.torrent === null || requestParameters.torrent === undefined) {
            throw new runtime.RequiredError('torrent','Required parameter requestParameters.torrent was null or undefined when calling createTorrent.');
        }
    ...
    /**
     */
    async getTorrentRaw(requestParameters: GetTorrentRequest): Promise<runtime.ApiResponse<Torrent>> {
        if (requestParameters.infoHash === null || requestParameters.infoHash === undefined) {
            throw new runtime.RequiredError('infoHash','Required parameter requestParameters.infoHash was null or undefined when calling getTorrent.');
        }
        ...
        const response = await this.request({
            path: `/api/torrents/:infoHash`.replace(`{${"infoHash"}}`, encodeURIComponent(String(requestParameters.infoHash))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
